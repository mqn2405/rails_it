...
ActiveRecord::Schema.define(version: 2020_12_02_231255) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.integer "restaurant_review_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["restaurant_review_id"], name: "index_likes_on_restaurant_review_id"
  ...
  add_foreign_key "likes", "restaurant_reviews"
